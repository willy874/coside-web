  ...
  return (
    <main className={styles.main}>
      <Container sx={{ maxWidth: "1280px" }}>
        <Typography sx={{ display: { xs: "block", md: "none" }, margin: "24px auto 16px", fontWeight: "700", fontSize: "24px", lineHeight: "28px", textAlign: "center", color: "#1E88E5" }}>隱私權政策</Typography>
        <Box sx={{ maxWidth: "805px", margin: { xs: "0 auto", md: "69px auto 0" }, borderRadius: "12px", padding: "32px", border: `1px solid ${theme.palette.grey[200]}` }}>
          <Typography sx={{ display: { xs: "none", md: "block" }, mb: "32px", fontWeight: "700", fontSize: "28px", textAlign: "center" }}>隱私權政策</Typography>
          <Box>
